    ...
    with open(csv_file_path, mode='w', newline='', encoding='utf-8') as file:
        ...
        while True:
            ...
            for container in product_containers:
                title_div = container.find('h3',
                                           class_='block m-0 line-clamp-2 font-regular text-base leading-sm text-darkOnyx-800 pt-0.5 h-full')
                price_div = container.find('span',
                                           class_='Label-sc-15v1nk5-0 Pricing___StyledLabel-sc-pldi2d-1 gJxZPQ AypOi')
                qty_div = container.find('span',
                                         class_='Label-sc-15v1nk5-0 PackChanger___StyledLabel-sc-newjpv-1 gJxZPQ cWbtUx')
                disc_div = container.find('span',
                                          class_='font-semibold lg:text-xs xl:text-sm leading-xxl xl:leading-md')
